...
channelKeys.push({channelNumber:211374, name:'RDS',key:'I5BKU454QJP1LRLX',
      fieldList:[{field:1,axis:'O'},{field:2,axis:'T'},{field:3,axis:'O'},{field:4,axis:'O'},{field:5,axis:'T'},{field:6,axis:'T'},{field:7,axis:'T'},{field:8,axis:'T'}]});
         ...
         var fieldStr = "data.feeds["+h+"].field"+fieldList[fieldIndex].field;
			...
			//p[1] = parseFloat(v);
		  	if(parseFloat(v)<(promedio+(promedio)) && parseFloat(v)>(promedio-(promedio)) ){//|| parseFloat(v) < (promedio-(promedio/2))){ // si el valor es 3 veces el promedio no lo muestra
				...
				p[1] = parseFloat(promedio);
				window.console && console.log('rechazado:',parseFloat(v));
			}
